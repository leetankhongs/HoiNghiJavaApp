 ...
 * @author ADMIN
 */
public class DetailConferenceUserDialog extends java.awt.Dialog {

    /**
     * Creates new form Register_DetailDialog
     */
    Conference conference;
    MainScreen mainScreen;

    public DetailConferenceUserDialog(java.awt.Frame parent, boolean modal, Conference conference) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jCancelRegistrationbtn = new javax.swing.JButton();
        ...
        jCancelRegistrationbtn.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jCancelRegistrationbtn.setText("Cancel Register");
        jCancelRegistrationbtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                jCancelRegistrationbtnMouseReleased(evt);
            }
        });
        jPanel5.add(jCancelRegistrationbtn);
    ...
    private void jCancelRegistrationbtnMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jCancelRegistrationbtnMouseReleased
        // TODO add your handling code here:
        String[] options = {"Yes", "No"};
        int result = JOptionPane.showOptionDialog(
                this,
                "Do you want to canel this registration?",
                "OPtion",
...
//            }
    ...
    private javax.swing.JButton jCancelRegistrationbtn;
