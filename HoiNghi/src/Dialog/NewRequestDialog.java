 ...
 * @author ADMIN
 */
public class NewRequestDialog extends java.awt.Dialog {
    ...
    public NewRequestDialog(java.awt.Frame parent, boolean modal, Conference conference) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo((Frame) parent);
        this.conference = conference;
        this.conferenceUI = MainScreen.getInstance().getConferenceUI();

        jNameTF.setText(conference.getName());
        jCapacityTF.setText(conference.getParticipants().toString());
