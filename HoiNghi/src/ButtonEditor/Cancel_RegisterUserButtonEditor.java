...
import Dialog.DetailConferenceUserDialog;
 ...
 * @author ADMIN
 */
public class Cancel_RegisterUserButtonEditor extends DefaultCellEditor {

    private JButton button;
    private Boolean clicked;
    private UserConference userConference;

    public Cancel_RegisterUserButtonEditor(JTextField txt) {
        super(txt);
